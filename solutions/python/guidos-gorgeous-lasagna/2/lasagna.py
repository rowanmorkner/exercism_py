...
def preparation_time_in_minutes(number_of_layers):
    """Calculate the total prep time in minutes

    Parameters: 
        number_of_layers (int): The number of desired layers

    Returns: 
        int: number of minutes expected to make the lasagna
    """
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time): 
    ...
    Returns: 
        int: Totoal minutes youve been cooking 
    """
